                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="registered-customers">
                                <h6 class="widget-title border-left mb-50">REGISTERED USERS</h6>
                                <form action="#">
                        ...
                        <div class="col-md-6">
                            <div class="new-customers">
                                <form action="#">
                                    <h6 class="widget-title border-left mb-50">NEW USERS</h6>
                                    <div class="login-account p-30 box-shadow">
                                        <div class="row">
                                            <div class="col-sm-6">
                                            ...
                                            <div class="col-sm-6">
                                                <select class="custom-select">
                                                    ...
                                                    <option value="c-1">Gujarat</option>
                                                    <option value="c-2">Maharastra</option>
                                                    <option value="c-3">UP</option>
                                                    <option value="c-4">MP</option>
                                                </select>
                                            </div>
                                            <div class="col-sm-6">
                                                <select class="custom-select">
